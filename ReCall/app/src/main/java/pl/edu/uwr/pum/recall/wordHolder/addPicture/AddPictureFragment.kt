package pl.edu.uwr.pum.recall.wordHolder.addPicture
...
import pl.edu.uwr.pum.recall.databinding.FragmentAddPictureBinding
        ...
        binding.buttonSavePicture.setOnClickListener {
            if (checkForErrors())
               ...
               viewModel.addWord(item)
                ...
                findNavController().navigate(AddPictureFragmentDirections.actionAddPictureFragmentToWordHost(itemLang))
            }
        }
    }
